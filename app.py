...
<div class="main-header">
    ...
    <p>Tác giả: Cao Thị Hạnh - Trường Tiểu học Đông Hà - ĐT: 0364961789</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Cao Thị Hạnh - Trường Tiểu học Đông Hà - ĐT: 0364961789</div>", unsafe_allow_html=True)
